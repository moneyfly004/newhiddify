...
class _ApiClient implements ApiClient {
  ...
  Future<AuthResponse> login(Map<String, dynamic> body) async {
    ...
    try {
      // 处理后台返回的包装格式：ResponseBase { success, message, data }
      final responseData = _result.data!;
      
      Map<String, dynamic> dataToParse;
      if (responseData.containsKey('data') && responseData['data'] != null) {
        // 如果响应被包装在 ResponseBase 中，提取 data 字段
        dataToParse = responseData['data'] as Map<String, dynamic>;
      } else {
        // 直接解析（兼容旧格式）
        dataToParse = responseData;
      }
      
      _value = AuthResponse.fromJson(dataToParse);
    } on Object catch (e, s) {
  ...
  Future<AuthResponse> register(Map<String, dynamic> body) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    // 注册 API 返回的是 {success, message, data: {id, email}}，不包含 token
    // 这里返回一个占位符，实际在 repository 中会调用登录 API
    late AuthResponse _value;
    try {
      // 注册成功，返回一个空的 AuthResponse（实际会在 repository 中调用登录）
      final responseData = _result.data!;
      Map<String, dynamic>? data;
      if (responseData.containsKey('data') && responseData['data'] != null) {
        data = responseData['data'] as Map<String, dynamic>?;
      }
      // 这里只是为了满足类型要求，实际不会使用这个返回值
      _value = AuthResponse(
        token: '',
        refreshToken: '',
        user: User(
  ...
  @override
  Future<Response<dynamic>> getSubscriptions() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<Subscription> getSubscription(String id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<Subscription>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<Response<dynamic>> getNodes() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<Node> getNode(String id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<Node>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late Node _value;
    try {
      _value = Node.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<NodeTestResult> testNode(String id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<NodeTestResult>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late NodeTestResult _value;
    try {
      _value = NodeTestResult.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<List<NodeTestResult>> batchTestNodes(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<List<NodeTestResult>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<NodeTestResult> _value;
    try {
      _value = _result.data!
          .map(
              (dynamic i) => NodeTestResult.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
