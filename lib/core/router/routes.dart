...
import 'package:hiddify/features/auth/pages/forgot_password_page.dart';
import 'package:hiddify/features/auth/pages/login_page.dart';
import 'package:hiddify/features/auth/pages/register_page.dart';
import 'package:hiddify/features/auth/pages/reset_password_page.dart';
...
import 'package:hiddify/features/shop/pages/shop_page.dart';
...
@TypedGoRoute<LoginRoute>(path: "/auth/login", name: LoginRoute.name)
...
@TypedGoRoute<RegisterRoute>(path: "/auth/register", name: RegisterRoute.name)
...
@TypedGoRoute<ForgotPasswordRoute>(path: "/auth/forgot-password", name: ForgotPasswordRoute.name)
...
@TypedGoRoute<ResetPasswordRoute>(path: "/auth/reset-password", name: ResetPasswordRoute.name)
class ResetPasswordRoute extends GoRouteData {
  ...
  Page<void> buildPage(BuildContext context, GoRouterState state) {
    ...
    return MaterialPage(
      fullscreenDialog: true,
      name: name,
      child: ResetPasswordPage(email: emailParam ?? email),
    );
  }
}
...
@TypedGoRoute<ShopRoute>(path: "/shop", name: ShopRoute.name)
class ShopRoute extends GoRouteData {
  ...
  Page<void> buildPage(BuildContext context, GoRouterState state) {
    ...
    return const NoTransitionPage(name: name, child: ShopPage());
  }
}
